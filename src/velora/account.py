...
@dataclass
class Account:
 id:str;name:str;walkbot:object;steam_id:str|None=None;enabled:bool=True;process_id:int|None=None;last_gsi:float|None=None;errors:list[str]=field(default_factory=list)
