...
class GsiSnapshot:
 ...
 position:tuple[float,float,float]|None=None; forward:tuple[float,float,float]|None=None; round_number:int|None=None; xp:int|None=None; player_team:str|None=None; team_score:int|None=None; opponent_score:int|None=None
