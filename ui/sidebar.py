...
class Sidebar(customtkinter.CTkFrame):
    def __init__(self, parent):
        ...
        self.logo_label = customtkinter.CTkLabel(self, text="VELORA", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))

        self.version_label = customtkinter.CTkLabel(self, text="PANEL", font=customtkinter.CTkFont(size=20, weight="bold"))
